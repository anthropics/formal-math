#!/usr/bin/env python3
"""Serialized-only exact verifier for stable-plus-refined 5D macro B&B certificates."""
...
def main() -> None:
    ...
    for certificate in certificates:
        ...
        for segment in segments:
            ...
            assert left == cursor and left <= right and 0 <= piece_index < 56
    ...
    report = {
        ...
        "trust_note": "Serialized streams and scalar certificates were replayed using exact Fraction arithmetic; floats appear only in decimal summaries.",
    }
