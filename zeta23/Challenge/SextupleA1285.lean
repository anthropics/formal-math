...
-/
/-
Challenge/SextupleA1285.lean — TRUSTED comparator challenge module for the
refined sextuple (six-translate) improvement of the simple critical-line
proportion at `A = 257 / 20000`.

The coefficient `0.6727949489` is strictly below the exact endpoint
`(6·B_MT − 10π·B₆)/(6 − 257 / 20000)` with `B₆ = 1094977/5000000000`.
`N0simple` counts simple on-line zeros; the denominator `Ncount` counts all
zeros with multiplicity.
Proof: Solution.SextupleA1285.  Config: comparator/config-sextuple-a1285.json.
...
/-- Fixed coefficient `0.6727949489` in dyadic windows. -/
...
/-- Fixed coefficient `0.6727949489` in cumulative windows. -/
