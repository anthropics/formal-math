...
/-- Subtree at topology cursor 1716440, payload cursor 858215, depth 15, 65 tokens. -/
theorem improvedChunk28355 :
    replayAffineTree improvedConcreteLeafCheck improvedTopologyStream improvedPayloadStream
      59 1716440 858215 (improvedPathBox improvedRootBox [(true, ⟨4, by decide⟩), (true, ⟨0, by decide⟩), (true, ⟨3, by decide⟩), (true, ⟨1, by decide⟩), (true, ⟨2, by decide⟩), (false, ⟨4, by decide⟩), (false, ⟨0, by decide⟩), (false, ⟨3, by decide⟩), (false, ⟨1, by decide⟩), (false, ⟨2, by decide⟩), (false, ⟨4, by decide⟩), (false, ⟨0, by decide⟩), (false, ⟨3, by decide⟩), (false, ⟨1, by decide⟩), (false, ⟨2, by decide⟩)]) =
      some (1716505, 858248) := by
  decide +kernel
